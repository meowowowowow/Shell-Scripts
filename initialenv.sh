...
if [ -z $1 ];then
	echo "错误，没有传入web服务器IP！用法：sh initialenv.sh [IP]"
	exit
fi
...
#  exit 1
#fi
curl -O http://$1:12888/packages/docker/docker-ce-19.03.15-3.el7.x86_64.rpm
curl -O http://$1:12888/packages/docker/docker-ce-cli-19.03.15-3.el7.x86_64.rpm
